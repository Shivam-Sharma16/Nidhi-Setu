  ...
  useEffect(() => {
    const fetchNomineeData = async () => {
      try {
        ...
        const response = await axios.get('http://localhost:5000/api/nominees/profile', {
          headers: {
        ...
        if (response.data.success) {
          const nominee = response.data.nominee;
          setNomineeDetails({
            name: nominee.name,
            email: nominee.email,
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (type === 'deathCertificate') {
          ...
          setSuccess('Death certificate uploaded successfully! An email notification has been sent.');
          ...
          setSuccess('Medical document uploaded successfully! An email notification has been sent to setunidhi0@gmail.com');
        }
